...
from models.excitation_block import SqueezeExcitationBlock, DeepConnection

class EXCITHED(nn.Module):
    """HED network."""

    def __init__(self, device):
        super(EXCITHED, self).__init__()
    ...
    def forward(self, x):
        ...
        conv4_3 = self.excitation_block4(conv4_3)
