...
from models.excitation_block import SqueezeExcitationBlock 
...
class EXCITOCTHED(nn.Module):
    ...
    def __init__(self, device, alpha, 
        ...
        super(EXCITOCTHED, self).__init__()
        # Layers.
        self.relu = nn.ReLU
        ...
        #Excitation
        self.excitation_block1 = SqueezeExcitationBlock(64)
        self.excitation_block2 = SqueezeExcitationBlock(128)
        self.excitation_block3 = SqueezeExcitationBlock(256)
        self.excitation_block4 = SqueezeExcitationBlock(512)
        self.excitation_block5 = SqueezeExcitationBlock(512)
    ...
    def forward(self, x):
        ...
        excitation_1 = self.excitation_block1(conv1_2)
        pool1 = self.maxpool(excitation_1)
        ...
        excitation_2 = self.excitation_block2(conv2_2)
        pool2 = self.maxpool_octave(excitation_2)
        ...
        excitation_3 = self.excitation_block3(conv3_3)
        pool3 = self.maxpool_octave(excitation_3)
        ...
        excitation_4 = self.excitation_block4(conv4_3)
        pool4 = self.maxpool_octave(excitation_4)
        ...
        excitation_5 = self.excitation_block5(conv5_3)

        score_dsn1 = self.score_dsn1(excitation_1)
        score_dsn2 = self.score_dsn2(excitation_2)
        score_dsn3 = self.score_dsn3(excitation_3)
        score_dsn4 = self.score_dsn4(excitation_4)
        score_dsn5 = self.score_dsn5(excitation_5)
