...
class OCTHEDFULL_SIDE_EXTRA(nn.Module):
    """OCTHEDFULL_SIDE network."""
    ...
    def __init__(self, device, alpha, 
        ...
        super(OCTHEDFULL_SIDE_EXTRA, self).__init__()
        # Layers.
        self.relu = nn.ReLU
        ...
        self.undo_octave2 = OctaveConv_ACT(128, 128, 1, alpha_in = alpha, alpha_out = 0, activation_layer=self.relu)
        self.score_dsn2 = nn.Conv2d(128, 1, 1)
        
        self.undo_octave3 = OctaveConv_ACT(256, 256, 1, alpha_in = alpha, alpha_out = 0, activation_layer=self.relu)
        self.score_dsn3 = nn.Conv2d(256, 1, 1)
        
        self.undo_octave4 = OctaveConv_ACT(512, 512, 1, alpha_in = alpha, alpha_out = 0, activation_layer=self.relu)
        self.score_dsn4 = nn.Conv2d(512, 1, 1)
        
        self.undo_octave5 = OctaveConv_ACT(512, 512, 1, alpha_in = alpha, alpha_out = 0, activation_layer=self.relu)
    ...
    def forward(self, x):
        ...
        score_octave2 = self.undo_octave2(conv2_2)[0]
        score_dsn2 = self.score_dsn2(score_octave2)
        
        score_octave3 = self.undo_octave3(conv3_3)[0]
        score_dsn3 = self.score_dsn3(score_octave3)
        
        score_octave4 = self.undo_octave4(conv4_3)[0]
        score_dsn4 = self.score_dsn4(score_octave4)
        
        score_octave5 = self.undo_octave4(conv5_3)[0]
        score_dsn5 = self.score_dsn5(score_octave5)
